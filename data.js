...
for (var i = 0; i < jsonContent.features.length; i++) {
  ...
  let property = new Property ({
    type: prop.type,
     properties:
      { us_congress: prop.properties.us_congres,
        ...
        typecategory: prop.properties.typecatego,
        ...
        acquisition: prop.properties.acquisitio,
        retired: toBoolean(prop.properties.retired),
        subcategory: prop.properties.subcategor,
        jurisdiction: prop.properties.jurisdicti,
